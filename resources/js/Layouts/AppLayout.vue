...
<template>
    <div>
        ...
        <div class="min-h-screen bg-gray-100">
            <nav v-if="$page.props.auth.user" class="bg-zinc-300 border-b border-gray-100">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <NavLink :href="route('bookings.past')" :active="route().current('bookings.past')">
                                    Past Bookings
                                </NavLink>
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ml-6">
                                ...
                                <Dropdown v-if="$page.props.jetstream.hasTeamFeatures" align="right" width="60">
                                    <template #trigger>
                                        <span class="inline-flex rounded-md">
                                            <button type="button" class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-zinc-300 hover:text-gray-700 focus:outline-none focus:bg-gray-50 active:bg-gray-50 transition ease-in-out duration-150">
                            ...
                            <div class="ml-3 relative">
                                <Dropdown align="right" width="48">
                                    <template #trigger>
                                        <button v-if="$page.props.jetstream.managesProfilePhotos" class="flex text-sm border-2 border-transparent rounded-full focus:outline-none focus:border-gray-300 transition bg-zinc-300">
                    ...
                    <div class="pt-4 pb-1 border-t border-gray-200">
                        <div class="flex items-center px-4">
                            <div v-if="$page.props.jetstream.managesProfilePhotos" class="shrink-0 mr-3">
                                <img class="h-10 w-10 rounded-full object-cover bg-zinc-300" :src="$page.props.auth.user?.profile_photo_url" :alt="$page.props.auth.user?.name">
                            </div>
            ...
            <div v-else class="sm:top-0 p-6 text-right bg-zinc-300 min-w-screen sm:min-w-screen md:min-w-screen lg:min-w-screen xl:min-w-screen mb-10">
                <Link 
